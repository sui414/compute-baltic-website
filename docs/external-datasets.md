...
- **vast.ai public pricing feeds** (`storage.googleapis.com/vast-public-gpu-pricing/`):
  `gpu-price-history.json` (**DISCONTINUED 2026-08-11** — our 2026-07-27 local snapshot is the final capture of utilization/fleet data; 95 GPUs, ~4-hour grain from 2026-01-28) and `gpu-pricing-public.json` (90-day
